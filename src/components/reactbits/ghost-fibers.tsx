...
// React Bits "Ghost Fibers" (reactbits.dev/backgrounds/ghost-fibers), installed from its registry.
// Used as-is apart from this client directive; colours and theme are set by the caller.
